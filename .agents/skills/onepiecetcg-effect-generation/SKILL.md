...
8. Pick the task path:
   ...
   - Refine generated placeholders into authored effects in `packages/effect-engine/src/definitions/`.
...
12. Keep changes declarative by default. Only use `definitions/<FAMILY>/special/` when a card cannot be represented safely or clearly by the DSL.
